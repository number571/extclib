...
* AES - CBC
*******************/
int aes_encrypt_cbc(const uint8_t in[], size_t in_len, uint8_t out[], const uint32_t key[], uint16_t keysize, const uint8_t iv[])
{
...
int aes_encrypt_cbc_mac(const uint8_t in[], size_t in_len, uint8_t out[], const uint32_t key[], uint16_t keysize, const uint8_t iv[])
{
	uint8_t buf_in[AES_BLOCK_SIZE], buf_out[AES_BLOCK_SIZE], iv_buf[AES_BLOCK_SIZE];
	int blocks, idx;
...
int aes_decrypt_cbc(const uint8_t in[], size_t in_len, uint8_t out[], const uint32_t key[], uint16_t keysize, const uint8_t iv[])
{
	uint8_t buf_in[AES_BLOCK_SIZE], buf_out[AES_BLOCK_SIZE], iv_buf[AES_BLOCK_SIZE];
	int blocks, idx;
...
void aes_encrypt_ctr(const uint8_t in[], size_t in_len, uint8_t out[], const uint32_t key[], uint16_t keysize, const uint8_t iv[])
{
...
void aes_decrypt_ctr(const uint8_t in[], size_t in_len, uint8_t out[], const uint32_t key[], uint16_t keysize, const uint8_t iv[])
{
...
int aes_encrypt_ccm(const uint8_t payload[], uint32_t payload_len, const uint8_t assoc[], uint16_t assoc_len,
                    const uint8_t nonce[], uint16_t nonce_len, uint8_t out[], uint32_t *out_len,
                    uint32_t mac_len, const uint8_t key_str[], uint16_t keysize)
{
...
int aes_decrypt_ccm(const uint8_t ciphertext[], uint32_t ciphertext_len, const uint8_t assoc[], uint16_t assoc_len,
                    const uint8_t nonce[], uint16_t nonce_len, uint8_t plaintext[], uint32_t *plaintext_len,
                    uint32_t mac_len, int *mac_auth, const uint8_t key_str[], uint16_t keysize)
{
...
void aes_key_setup(const uint8_t key[], uint32_t w[], uint16_t keysize)
{
	int Nb=4,Nr,Nk,idx;
...
void aes_encrypt(const uint8_t in[], uint8_t out[], const uint32_t key[], uint16_t keysize)
{
	uint8_t state[4][4];
...
void aes_decrypt(const uint8_t in[], uint8_t out[], const uint32_t key[], uint16_t keysize)
{
	uint8_t state[4][4];
