...
static void _set_tree(tree_node *node, vtype_t tkey, vtype_t tvalue, void *key, void *value);
...
static void _print_tree_as_list(tree_node *node, vtype_t tkey, vtype_t tvalue);
